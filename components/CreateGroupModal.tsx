            ...
            <div className="max-h-60 overflow-y-auto space-y-1 custom-scrollbar pr-2">
              {users.map((user) => (
                <div
                  ...
                  className={`flex items-center justify-between p-3 cursor-pointer transition-colors border-l-2 ${selectedUsers.includes(user.uid)
                ...
                >
                  ...
                  <div
                    className={`w-6 h-6 border flex items-center justify-center shrink-0 font-black text-[10px] ${selectedUsers.includes(user.uid)
