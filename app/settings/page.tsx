          ...
          <section className="bg-surface p-6 border border-border bg-secondary/5">
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <button
                type="button"
                onClick={toggleTheme}
                className={`relative w-16 h-9 border border-border transition-colors ${theme === "dark" ? "bg-identity/20" : "bg-secondary/40"
                  }`}
                aria-pressed={theme === "dark"}
              >
                <span
                  className={`absolute top-0.5 left-0.5 w-7 h-7 border border-border transition-transform flex items-center justify-center text-xs font-black ${theme === "dark"
